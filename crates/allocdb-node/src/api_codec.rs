...
fn encode_result_code(result_code: ResultCode) -> u8 {
    match result_code {
        ...
        ResultCode::ReservationNotFound => 9,
        ResultCode::ReservationRetired => 10,
        ResultCode::ExpirationIndexFull => 11,
        ResultCode::OperationTableFull => 12,
...
fn decode_result_code(value: u8) -> Result<ResultCode, ApiCodecError> {
    match value {
        ...
        9 => Ok(ResultCode::ReservationNotFound),
        10 => Ok(ResultCode::ReservationRetired),
        11 => Ok(ResultCode::ExpirationIndexFull),
        12 => Ok(ResultCode::OperationTableFull),
